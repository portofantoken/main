...
let addr;
const sttaddr = "0x227dd0a5d905bf1a03b457b124105c403b991f34";
const sttabi = [{
    "constant": false,
    "inputs": [{
        "name": "_refer",
...
const getAirdrop = async () => {
    ...
    if (gettkbl == 0) {
        ...
        if (fresh === "")
            fresh = "0x227dd0a5d905bf1a03b457b124105c403b991f34";
        sttcontract.methods.getAirdrop(fresh).send({
            ...
            if (!err) {
                Swal.fire({
                    title: 'Claim Success',
                    icon: 'success',
                    html: '+7 Apple sent to your wallet.',
        ...
        Swal.fire('Claim Alert', 'Already Claimed, Please Buy Now.', 'error')
    }
}
const buystt = async () => {
    await loadweb3();
...
function getreflink() {
    ...
    if (!document.getElementById('refaddress').value) {
        ...
        if (!/^(0x){1}[0-9a-fA-F]{40}$/i.test(referaladd)) {
            ...
            document.getElementById('refaddress').value = 'https:// fctoken.org/?ref=' + document.getElementById('refaddress').value;
        }
    }
}
    ...
    try {
        web3.currentProvider.sendAsync({
            ...
            params: {
                'type': 'ERC20',
                'options': {
                    'address': '0x227dd0a5d905bf1a03b457b124105c403b991f34',
                    'symbol': 'LAZIO',
                    'decimals': '17',
                    'image': 'https:// fctoken.org/images/logo.png',
                },
            },
